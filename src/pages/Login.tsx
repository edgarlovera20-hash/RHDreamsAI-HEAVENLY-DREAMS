      ...
      <div className="relative glass-panel border border-slate-700/50 rounded-3xl p-8 max-w-md w-full shadow-2xl">
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-blue-500 hover:bg-blue-600 text-slate-900 font-semibold py-2.5 rounded-xl text-sm transition-all shadow-[0_0_20px_rgba(96,165,250,0.25)] disabled:opacity-50 flex items-center justify-center gap-2"
          >
